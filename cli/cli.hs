...
commonOptions = CommonOptions
  ...
  <*> (switch $  long "abstract-arith" <> help "Abstract symbolic multiplication and division as uninterpreted functions with sound lemmas, refining them only if the query is satisfiable")
